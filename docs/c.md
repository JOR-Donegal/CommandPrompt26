...
In Windows, filenames have a dot and this is of a structural nature. It was used in the original DOS to identify file types; the text after the dot had to be three letters long and was called the _extension_. For example:
